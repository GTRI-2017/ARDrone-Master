...
double altitude = 150; //variable set since altitude is a data point being imported, altd given in cm via nav data 
...
geometry_msgs::Twist takeoff_msg;
...
int main(int argc, char **argv)
  	...
  	while (ros::ok )  
    	{
      	while (altitude < 150) // while for takeoff
      		{
          	ROS_INFO("Taking Off");
